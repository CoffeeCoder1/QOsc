    ...
    QOscInterface(parent)
{
    QObject::connect(&socket, &QAbstractSocket::readyRead,
                     this,    &QOscUdpInterface::readReady);
    rebind();
}
...
quint16 QOscUdpInterface::getRemotePort() const
{
    return remotePort;
}
...
quint16 QOscUdpInterface::getLocalPort() const
{
    return localPort;
}
...
bool QOscUdpInterface::getIsListening() const
{
    return isListening;
}

...
#define QOSC_PRIVATE_ACCESS(FType, Type, OSCType, Default)                                 \
	...
	virtual inline void from##FType(const Type &value) {                                   \
		Q_UNUSED(value)                                                                    \
		Q_ASSERT_X(false, "from" #FType, "Not a " #FType);                                 \
	}                                                                                      \
...
public:
	QOscValuePrivate(QOsc::ValueType t) :
			type(t) {}
...
protected:
	QOscInt32Private(QOsc::ValueType t) :
			QOscValuePrivate(t) {}

public:
	QOscInt32Private() :
			QOscValuePrivate(QOsc::Int32Type) {}
...
public:
	QOscInt64Private() :
			QOscValuePrivate(QOsc::Int64Type) {}
...
public:
	QOscFloat32Private() :
			QOscValuePrivate(QOsc::Float32Type) {}
...
public:
	QOscFloat64Private() :
			QOscValuePrivate(QOsc::Float64Type) {}
...
public:
	QOscCharPrivate() :
			QOscInt32Private(QOsc::CharType) {};
...
public:
	QOscColorPrivate() :
			QOscValuePrivate(QOsc::ColorType) {}
...
public:
	QOscMidiPrivate() :
			QOscValuePrivate(QOsc::MidiType) {}
...
protected:
	QOscStringPrivate(QOsc::ValueType t) :
			QOscValuePrivate(t) {}

public:
	QOscStringPrivate() :
			QOscValuePrivate(QOsc::StringType) {}
...
public:
	QOscSymbolPrivate() :
			QOscStringPrivate(QOsc::SymbolType) {}
...
public:
	QOscBlobPrivate() :
			QOscValuePrivate(QOsc::BlobType) {}
...
public:
	QOscTimeTagPrivate() :
			QOscValuePrivate(QOsc::TimeTagType) {}
	...
	inline QDateTime toTimeTag(const QDateTime &) const override { return QDateTime::fromMSecsSinceEpoch(toUnixEpoch() * 1000, QTimeZone(QTimeZone::UTC)); }
